        ...
        for (i in 0 until tests.length()) {
            ...
            if (normalizedType == "docsisexpert" || normalizedType == "channelexpert") {
                ...
                fun applyPilotTolerance(
                    ...
                    return target != null && tolerance != null &&
                ...
                if (rules != null) {
                    ...
                    pilotLevels.forEach { (channel, level) ->
                        ...
                        if (rule?.has("source") == true) {
                            ...
                            pilotOk[channel] = applyPilotTolerance(adjusted, target, ruleTolerance)
                        } else {
                            ...
                            pilotOk[channel] = if (ruleTolerance != null || target != null) {
                                applyPilotTolerance(adjusted, target, ruleTolerance)
                            } else {
                                true
                            }
                        }
